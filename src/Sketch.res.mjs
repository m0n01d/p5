...
function sketch(p) {
  ...
  var applyCustomSize = function () {
    ...
    var widthMm = Core__Option.getWithDefault(Core__Float.fromString(widthInput.value), 210.0);
    var heightMm = Core__Option.getWithDefault(Core__Float.fromString(heightInput.value), 297.0);
